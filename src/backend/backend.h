...
struct backend_operations {
  ...
  void (*_compose)(backend_t *backend_data, void *image_data, int dst_x1, int dst_y1, int dst_x2,
                   int dst_y2, const region_t *reg_paint, const region_t *reg_visible);
  ...
  void (*destroy_shadow_context)(backend_t *backend_data, struct backend_shadow_context *ctx);
  ...
  uint64_t (*get_shader_attributes)(backend_t *backend_data, void *shader) attr_nonnull(1, 2);
  ...
  bool (*is_image_transparent)(backend_t *backend_data, void *image_data) attr_nonnull(1, 2);
  ...
  /// original image
  void *(*clone_image)(backend_t *base, const void *image_data, const region_t *reg_visible);
